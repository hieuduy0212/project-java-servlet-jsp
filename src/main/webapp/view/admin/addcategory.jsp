                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Enter category's info</h1>
                                        </div>
                                        <form class="user" method="post"
                                              action="<c:url value="/view/admin/add-category"/>"
                                            ...
                                            <button type="submit" class="btn btn-primary btn-lg btn-block" id="btnAddCategory" disabled>Add category</button>
                                            <hr>
                                        </form>
                                        <hr>
                                    </div>
...
<script>
    ...
    if(msg=="successAddCategory"){
        swal({text:"Successfully added category", icon: "success"});
    }else if(msg=="errorAddCategory"){
        swal({text:"Failed to add category", icon: "error"});
    }
</script>
