        ...
        <div class="col-xl-10 col-lg-12 col-md-9">
          <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
              ...
              <div class="row">
                <div class="col-lg-4 " style="display: flex;justify-content: center;align-items:center"><img style="max-width: 100%" src="<c:url value="/view/admin/img/${account.avatar}"/> "/></div>
                <div class="col-lg-8">
                  <input type="hidden" id="message" value="${message}">
                  <div class="text-left" style="padding-top: 10px;padding-left: 10px" >
                    <a class="small" href="<c:url value="/view/admin/user"/>"><i class="fa fa-arrow-circle-left"></i> User list</a>
                  </div>
                  <div class="p-5">
                    <div class="text-center">
                      <h1 class="h4 text-gray-900 mb-4">Edit user's info</h1>
                    </div>
                    <form class="user" method="post"
                          action="<c:url value="/view/admin/edit-user"/>"
                          enctype="multipart/form-data">
                      <div class="form-group">
                        <input name="name" type="text" class="form-control form-control-user"
                               id="name" placeholder="Name" value="${account.name}">
                      </div>
                      <div class="form-group">
                        <input name="email" type="text" class="form-control form-control-user"
                               id="email" placeholder="Email" value="${account.email}">
                      </div>
                      <div class="form-group">
                        <input name="file-avatar" type="file"
                               class="form-control form-control-user"
                               id="file-avatar" style="padding: 0.3rem 1rem 1.9rem;">
                      </div>
