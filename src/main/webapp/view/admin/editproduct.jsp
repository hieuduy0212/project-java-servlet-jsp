                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Edit product's info</h1>
                                        </div>
                                        <form class="user" method="post"
                                              action="<c:url value="/view/admin/edit-product"/>"
                                              onsubmit="return checkEditProduct()" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <input name="title" type="text" class="form-control form-control-user"
                                                       id="title" placeholder="Title" value="${product.title}">
                                            </div>

                                            <div class="form-group">
                                                <h6>Description</h6>
                                                <textarea name="description" rows="5" class="form-control form-control-user"
                                                          style="resize: both;width: 100%;border-radius: 14px;">${product.description}</textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group user-select-auto">
                                                <select name="category" id="category" class="custom-select">
                                                    ...
                                                    <c:forEach items="${listC}" var="o">
                                                        <c:choose>
                                                            <c:when test="${product.cateID == o.id}">
                                                                <option value="${o.id}" selected="selected">${o.id} - ${o.cname}</option>
                                                            </c:when>
                                                            <c:otherwise>
                                            ...
                                            <button type="submit" class="btn btn-primary btn-lg btn-block">Edit product</button>
                                            <hr>
                                        </form>
                                        <hr>
                                    </div>
