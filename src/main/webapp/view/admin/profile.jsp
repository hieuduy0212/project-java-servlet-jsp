        ...
        <div class="card-body p-0">
            ...
            <div class="row">
                <div class="col-lg-5" style="display: flex;justify-content: center;align-items:center">
                    <img style="max-width: 100%;display: block" src="<c:url value="/view/admin/img/${sessionScope.account.avatar}"/>"/>
                </div>
                <div class="col-lg-7">
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<c:url value="/view/user/profile"/>"
                              onsubmit="return checkRegister()" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                    ...
                                    <input class="form-control" type="file" id="formFile" name="fileavatar"
                                        accept="image/*" style="border-radius: 10rem;padding: 0.4rem 1rem 2rem;font-size: .8rem;"
                                    >
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary btn-lg btn-block">Update Infomation</button>
                        </form>
                        <hr>
                        <a href="<c:url value="/view/user/password"/>"  style="color:black;">Change password</a>
                    </div>
                </div>
            </div>
        </div>
