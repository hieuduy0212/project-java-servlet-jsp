            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-6 mb-4">
                    <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            <a href="<c:url value="/view/admin/count"/>">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-lg font-weight-bold text-primary text-uppercase mt-1">
                                            Number of products
                                        </div>
                                        <div class="h5 mb-0 font-weight-bold text-primary">BY CATEGORY</div>
                                    </div>
                                    <div class="col-auto">
